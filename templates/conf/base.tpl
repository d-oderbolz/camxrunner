...
# If "${CXR_SKIP_ALL}" is given, all single preprocessors are skipped
...
CXR_PHOTOLYSIS_RATES_FILE_RULE='${CXR_INPUT_DIR}/tuv_${CXR_CAMX_CUSTOMER}_${CXR_CAMX_PERIOD}.out'
