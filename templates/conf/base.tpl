...
case "${CXR_AEROSOL_MECHANISM}" in
	...
	CF)
		...
		case "${CXR_CHEMICAL_MECHANISM}" in
			...
			*)	main_dieGracefully "The chemical mechanism ${CXR_CHEMICAL_MECHANISM} is not supported by this configuration file"
				;;
			
		esac # Chemical Mechanism
		;;
		
	*) main_dieGracefully "The aerosol mechanism ${CXR_AEROSOL_MECHANISM} is not supported by this configuration file!"
	   ;;
