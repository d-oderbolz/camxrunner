	...
	then
		...
		case $(basename ${CXR_STATION_PROC_INPUT_FILE} .pro) in
			...
			extract_arpa_stations)
				...
				$(basename ${CXR_STATION_PROC_INPUT_FILE} .pro),'${CXR_MODEL_INPUT_FILE}','${CXR_STATION_OUTPUT_DIR}',${write_header},${CXR_DAY},${CXR_MONTH},${CXR_YEAR},${stations_array},'${CXR_TEMP_GRID_FILE}','${CXR_ZP_GRID_FILE}',norm_method='${CXR_NORM_METHOD}',0
				exit
				EOF
				;;
