...
################################################################################
{
	...
	do
		...
		# Average files are done by <convert_output>

		#Checks
		CXR_CHECK_THESE_INPUT_FILES="$CXR_CHECK_THESE_INPUT_FILES ${CXR_TERRAIN_GRID_ASC_INPUT_ARR_FILES[${i}]} ${CXR_ZP_GRID_INPUT_ARR_FILES[${i}]} ${CXR_WIND_GRID_INPUT_ARR_FILES[${i}]} ${CXR_TEMP_GRID_INPUT_ARR_FILES[${i}]} ${CXR_VAPOR_INPUT_ARR_FILES[${i}]} ${CXR_KV_GRID_INPUT_ARR_FILES[${i}]}"
	
	done
	
	# We will later loop over these arrays
	CXR_INPUT_ARRAYS=(CXR_TERRAIN_GRID_ASC_INPUT_ARR_FILES CXR_ZP_GRID_INPUT_ARR_FILES CXR_WIND_GRID_INPUT_ARR_FILES CXR_TEMP_GRID_INPUT_ARR_FILES CXR_VAPOR_INPUT_ARR_FILES CXR_KV_GRID_INPUT_ARR_FILES)
	CXR_NAME_ARRAYS=(CXR_TERRAIN_GRID_NAME CXR_ZP_GRID_NAME CXR_WIND_GRID_NAME CXR_TEMP_GRID_NAME CXR_VAPOR_GRID_NAME CXR_KV_GRID_NAME)
