...
################################################################################
{
 ...
 ${CXR_KV_GRID_ASC_INPUT_FILE}"
	...
	do
		CXR_CHECK_THESE_OUTPUT_FILES="$CXR_CHECK_THESE_OUTPUT_FILES $CXR_DIRECT_OUTPUT_DIR/$(common.string.toLower $(basename ${CXR_AVG_ASC_INPUT_FILE}))_$(common.string.leftPadZero $hour 2)"
	done
...
################################################################################
{
	...
	then
		...
		then
			...
			main.log -a  "${CXR_AQMFAD_EXEC} dir_direct=$CXR_DIRECT_OUTPUT_DIR fi_aqm=${CXR_AVG_ASC_INPUT_FILE} fi_terrain=${CXR_TERRAIN_GRID_ASC_INPUT_FILE} fi_zp=${CXR_ZP_GRID_ASC_INPUT_FILE} fi_tp=${CXR_TEMP_GRID_ASC_INPUT_FILE} fi_qa=${CXR_VAPOR_ASC_INPUT_FILE} fi_kv=${CXR_KV_GRID_ASC_INPUT_FILE} fi_uv=${CXR_WIND_GRID_ASC_INPUT_FILE}"

			# Call aqmfad while collecting stderr only
			${CXR_AQMFAD_EXEC} dir_direct=$CXR_DIRECT_OUTPUT_DIR fi_aqm=${CXR_AVG_ASC_INPUT_FILE} fi_terrain=${CXR_TERRAIN_GRID_ASC_INPUT_FILE} fi_zp=${CXR_ZP_GRID_ASC_INPUT_FILE} fi_tp=${CXR_TEMP_GRID_ASC_INPUT_FILE} fi_qa=${CXR_VAPOR_ASC_INPUT_FILE} fi_kv=${CXR_KV_GRID_ASC_INPUT_FILE} fi_uv=${CXR_WIND_GRID_ASC_INPUT_FILE} 2>> $CXR_LOG
		else
