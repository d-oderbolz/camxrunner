...
c
      parameter(VEROSAT=
     &             'Ozone Source Apportionment Technology, OSAT 100614')
      parameter(VERGOAT=
     &         'Goegraphic Ozone Apportionment Technology, GOAT 100614')
      parameter(VERAPCA=
     &      'Anthropogenic Precursor Culpability Analysis, APCA 100614')
      parameter(VERDDM=          'De-coupled Direct Method, DDM 100614')
      parameter(VERHDDM=
     &                'High-order Decoupled Direct Method, HDDM 100614')
      parameter(VERPA=                    'Process Anaylsis, PA 100614')
      parameter(VERRTRAC=              'Reactive Tracers, RTRAC 100614')
      parameter(VERRTCMC=              'Reactive Tracers, RTCMC 100614')
      parameter(VERPSAT=
     &          'Particulate Source Apportionment Tracers, PSAT 100614')
c
c-----------------------------------------------------------------------
