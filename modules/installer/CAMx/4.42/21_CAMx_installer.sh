...
################################################################################
{
	...
	then
		...
		cd $input_dir || main.die_gracefully "${FUNCNAME}:${LINENO} - Could not change to $input_dir"
		...
		cd $CXR_CAMX_SRC_DIR || main.die_gracefully "${FUNCNAME}:${LINENO} - Could not change to $CXR_CAMX_SRC_DIR"
