...
c
      parameter(VEROSAT='Ozone Source Apportionment Technology, OSAT 081
     &0522')
     ...
     &PCA 080522')
      parameter(VERDDM='De-coupled Direct Method, DDM 080522')
      parameter(VERPA='Process Anaylsis, PA 080522')
      parameter(VERRTRAC='Reactive Tracers, RTRAC 080522')
...
c
     ...
     &                lo3sp, lvocsoa, crbnum, mwspec, rkohrt, rmirrt,
     &                wtkoh, wtmir, yrates
c
c-----------------------------------------------------------------------
