...
################################################################################
{
	...
	do
		...
		main.log -a " including buffer    X: ${x} Y: ${y} Z: ${z}"
...
################################################################################
{
	...
	main.log -a "................................................................................"
	main.log -a " Chemparam file      ${CXR_CHEMPARAM_INPUT_FILE}"
	main.log -a "................................................................................"
	main.log -a " Chemistry Solver    ${CXR_CHEMISTRY_SOLVER}"
	main.log -a "................................................................................"
	main.log -a " Advection Solver    ${CXR_ADVECTION_SOLVER}"
	main.log -a "................................................................................"
	main.log -a " Chemistry           ${CXR_CHEMISTRY}"
	main.log -a "................................................................................"
	main.log -a " Mission             ${CXR_MISSION:--}"
	main.log -a "................................................................................"
	main.log -a " Mail to             ${CXR_MAILADDR:--}"
	main.log -a "................................................................................"
	main.log -a " Start Date          ${CXR_START_DATE} (week $(common.date.WeekOfYear ${CXR_START_DATE}))"
	main.log -a "................................................................................"
	main.log -a " Stop Date           ${CXR_STOP_DATE} (week $(common.date.WeekOfYear ${CXR_STOP_DATE}))"
	main.log -a "................................................................................"
	main.log -a " # Days              ${CXR_NUMBER_OF_SIMULATION_DAYS}"
	main.log -a "................................................................................"
	...
	main.log -a "................................................................................"
	main.log -a " Dry Deposition      ${CXR_DRY_DEPOSITION} (${CXR_DRYDEP_MODEL:-})"
	main.log -a "................................................................................"
	main.log -a " Wet Deposition      ${CXR_WET_DEPOSITION} "
	main.log -a "................................................................................"
	main.log -a " TUV Cloud adjust    ${CXR_TUV_CLOUD_ADJUST:-not set}"
	main.log -a "................................................................................"
	main.log -a " # Photolyt. react.  ${CXR_TUV_NO_OF_REACTIONS}"
	main.log -a "................................................................................"
	main.log -a " TUV reactions       ${CXR_TUV_REACTION_NUMBERS}"
	main.log -a "................................................................................"
	...
	then
		...
		if [[ -f "$destination"  ]]
			then
				...
				if [[ $(common.user.getOK "$destination already exists. Do you want to overwrite this file? (If you say no we keep the existing file and continue.)" N ) == false ]]
				then
					return $CXR_RET_OK
				fi
			fi
...
################################################################################
{
	...
	# trim spaces at left and right end
	addition="$(common.string.trim "$addition")"
	
	# Replace any spaces in the string by _
	addition="${addition// /_}"
