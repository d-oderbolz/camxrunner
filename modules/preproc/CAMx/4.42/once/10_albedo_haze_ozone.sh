...
{	
	...
	# Evaluate some rules
	CXR_AHOMAP_OUTPUT_FILE="$(cxr_common_evaluate_rule "$CXR_ALBEDO_HAZE_OZONE_FILE_RULE" false CXR_ALBEDO_HAZE_OZONE_FILE_RULE)"
...
################################################################################
{
	...
	CXR_RUN=CAMx-v4.51-co5-s160-sem063-run1
