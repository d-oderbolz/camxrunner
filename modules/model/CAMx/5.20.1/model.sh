...
CXR_META_MODULE_VERSION='$Id: model.sh 5047 2010-10-20 19:05:55Z oderbolz $'
...
################################################################################
{
	...
	CXR_CHECK_THESE_INPUT_FILES="$CXR_CHECK_THESE_INPUT_FILES $CXR_PHOTOLYIS_RATES_INPUT_FILE $CXR_BOUNDARY_CONDITIONS_INPUT_FILE $CXR_ALBEDO_HAZE_OZONE_INPUT_FILE"
