      subroutine emistrns(igrd,chtime,chdate,numprocs,iproc_id,lupdtdep)
      use filunit
      use grid
      use grid_nodes
      use chmstry
...
c
     ...
     &             nlay(igrd),nspec,MAX(1,ntotsp),deltat(igrd),
     &             deltax(1,igrd),deltay(igrd),
     &             idfin(iptr2d(igrd)),depth(iptr3d_full(igrd)),
...
c
     ...
     &                ipsa3d(igrd),tarray2,ipacl_2d(iptr2d_full(igrd)),
     &                ipacl_3d(iptr3d_full(igrd)),iproc_id )
             endif
c
...
c
     ...
     &              height(iptr3d_full(igrd)),press(iptr3d(igrd)),
     &              windu(iptr3d(igrd)),windv(iptr3d(igrd)),
     &              fcloud(iptr3d(igrd)),
...
c
     ...
     &          .TRUE.,igrd,ncol(igrd),nrow(igrd),nlay(igrd),nspec,
...
c
     ...
     &                  ntotsp,notimespc,deltat(igrd),deltax(1,igrd),
     ...
     &                  fluxdum,fluxtmp,ptdryfld(ipsadep(igrd)),
     &                  ipsa3d(igrd),tarray2,iproc_id,
     &                  ipacl_2d(iptr2d_full(igrd)),
     &                  ipacl_3d(iptr3d_full(igrd)),
     ...
     &                  tsurf(iptr2d(igrd)),mapscl(iptr2d(igrd)),
     &                  sfcz0(iptr2d(igrd)),ptconc(ipsa3d(igrd)),
     &                  fluxdum,fluxtmp,depdum,ipsa3d(igrd),
