...
c
      ...
      real   pspt(MXVEC2D)
c
      common /store2d/ cellon, cellat, mapscl, topo, tsurf, pspt
c
c-----------------------------------------------------------------------
...
c
     ...
     &                 pppt, height, phpt, rkv, pkpt, water, pwpt,
     &                 fcloud, depth, rkx, rky, aremis, cwc, pwr, pws,
     &                 pwg, cod, cldtrns, cph
c
c-----------------------------------------------------------------------
...
c
      ...
      real   wnxt(MXVEC3D)
c
      common /newdat/  hnxt, pnxt, unxt, vnxt, tnxt, tsnxt, knxt, wnxt
