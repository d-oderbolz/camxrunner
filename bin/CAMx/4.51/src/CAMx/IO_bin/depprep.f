...
c
      write(idep(1)) ifile,note,nseg,4*navspc,idat1,tim1,idat2,tim2
     ...
     &               ione,izero,izero,zero,zero,zero
      ...
      write(idep(1)) ((dpspec(n,l),n=1,10),l=1,4*navspc)
...
c
      do i = 2,ngrid
        ...
        write(idep(i)) ifile,note,nseg,4*navspc,idat1,tim1,idat2,tim2
     ...
     &                 nrow(i),ione,izero,izero,zero,zero,zero
        ...
        write(idep(i)) ((dpspec(n,l),n=1,10),l=1,4*navspc)
      enddo
c
 9999 continue
      return
