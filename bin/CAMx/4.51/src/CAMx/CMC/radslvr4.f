...
c
      if (ldark) then
        ...
        Loss(kO1D  )= +( 1.000)*r( 10)+( 1.000)*r( 11)+( 1.000)*r( 97)
        Gain(kO1D  )= +( 1.000)*r(  9)
...
c
     ...
     &                +( 0.890)*r( 14)+( 1.000)*r(100)
      ...
      r( 99) = rk( 99)*cncrad(kOH)*cncrad(kO)
      r(102) = rk(102)*cncrad(kHO2)*cncrad(kO)
      r(103) = rk(103)*conc(kH2O2)*cncrad(kO)
      r(104) = rk(104)*cncrad(kNO3)*cncrad(kO)
      endif
c
c  new group of radicals
c
...
c
     ...
     &                +( 1.000)*rk(104)*cncrad(kO)
     &                +( 1.000)*rk(105)*cncrad(kOH)
     &                +( 1.000)*rk(106)*cncrad(kHO2)
     &                +( 1.000)*rk(107)*conc(kO3)
     &                +( 2.000)*rk(108)*cncrad(kNO3)
      lsNO3 = 1.0 + dt*lsNO3
      ...
      r(104) = rk(104)*cncrad(kNO3)*cncrad(kO)
      r(105) = rk(105)*cncrad(kNO3)*cncrad(kOH)
      r(106) = rk(106)*cncrad(kNO3)*cncrad(kHO2)
      r(107) = rk(107)*cncrad(kNO3)*conc(kO3)
      r(108) = rk(108)*cncrad(kNO3)*cncrad(kNO3)
      r(111) = rk(111)*cncrad(kN2O5)
c
c  new group of radicals
c
...
c
      ...
      r( 98) = rk( 98)*cncrad(kOH)*H2
      r( 99) = rk( 99)*cncrad(kOH)*cncrad(kO)
      r(100) = rk(100)*cncrad(kOH)*cncrad(kOH)
      r(101) = rk(101)*cncrad(kOH)*cncrad(kOH)
      r(102) = rk(102)*cncrad(kHO2)*cncrad(kO)
      r(105) = rk(105)*cncrad(kNO3)*cncrad(kOH)
      r(106) = rk(106)*cncrad(kNO3)*cncrad(kHO2)
