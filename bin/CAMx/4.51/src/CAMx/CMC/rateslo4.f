...
c
        ...
        Loss(kHNO3 )= +( 1.000)*r( 27)+( 1.000)*r(110)
     ...
     &                +( 1.000)*r(106)
        ...
        Loss(kPNA  )= +( 1.000)*r( 30)+( 1.000)*r( 31)+( 1.000)*r(113)
        Gain(kPNA  )= +( 1.000)*r( 29)
        Loss(kH2O2 )= +( 1.000)*r( 34)+( 1.000)*r( 35)+( 1.000)*r(103)
        Gain(kH2O2 )= +( 1.000)*r( 32)+( 1.000)*r( 33)+( 1.000)*r(101)
        Loss(kCO   )= +( 1.000)*r( 36)
