...
c
     ...
     &                +( 1.000)*r( 20)
      ...
      r(217) = rk(217)*conc(kMBUT)*cncrad(kO)
      endif
c
c  new group of radicals
c
...
c
     ...
     &                +( 1.000)*rk(216)*conc(kMBUT)
      ...
      r(216) = rk(216)*conc(kMBUT)*cncrad(kNO3)
c
c  new group of radicals
c
...
c
        ...
        Gain(kTBUO )= +( 0.236)*r(199)+( 0.016)*r(213)
c
c  first order method chosen for this radical
c  solved by direct substitution
c
...
c
     ...
     &                      +( 1.000)*r(107)
          ...
          JAC(kTBUO,kOH  )= +(-0.236)*r(199)+(-0.016)*r(213)
...
c
      ...
      r(212) = rk(212)*conc(kETOH)*cncrad(kOH)
      r(213) = rk(213)*conc(kMTBE)*cncrad(kOH)
      r(214) = rk(214)*conc(kMBUT)*cncrad(kOH)
