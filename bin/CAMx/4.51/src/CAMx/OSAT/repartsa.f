c*** REPARTSA.F
c
      subroutine repartsa(igrid,icell,jcell,kcell,modcon,delcon)
      implicit none
c
c----CAMx v4.51 080522
c
...
c
     ...
     &                                             nlay(igrid)*(ipo1-1)
            idxppa = idxcel + ncol(igrid)*nrow(igrid)*
     &                                             nlay(igrid)*(ippa-1)
...
c
     ...
     &                                             nlay(igrid)*(ipo3-1)
            idxppb = idxcel + ncol(igrid)*nrow(igrid)*
     &                                             nlay(igrid)*(ippb-1)
...
c
         ...
         do i=iptcls(idxipt(ITRCG6)),nptcls(idxipt(ITRCG6))
            idxcg6 = idxcel + ncol(igrid)*nrow(igrid)*nlay(igrid)*(i-1)
            ipo6 = ipo6 + 1
            ippb = ippb + 1
            idxpo6 = idxcel + ncol(igrid)*nrow(igrid)*
     &                                             nlay(igrid)*(ipo6-1)
            idxppb = idxcel + ncol(igrid)*nrow(igrid)*
     &                                             nlay(igrid)*(ippb-1)
...
c
         ...
         do i=iptcls(idxipt(ITRCG7)),nptcls(idxipt(ITRCG7))
            idxcg7 = idxcel + ncol(igrid)*nrow(igrid)*nlay(igrid)*(i-1)
            ipo7 = ipo7 + 1
            idxpo7 = idxcel + ncol(igrid)*nrow(igrid)*
     &                                             nlay(igrid)*(ipo7-1)
