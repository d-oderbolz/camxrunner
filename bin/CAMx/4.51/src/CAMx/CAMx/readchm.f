...
c        01/08/06  Added Mechanism 6 (CB05)
c                  Revised the code to re-order fast species (now use FASTS lists)
c        01/10/07  PM modules now linked to mechanisms 4 thru 6
c        07/04/07  Added code to set pointer to hydrolysis of N2O5
c
c     Input arguments: 
c        none 
c 
...
c
      ...
      character*10 fasts3(4), fasts5(13), fasts6(5)
      character*10 nmrad1(14), nmrad3(12), nmrad5(18), nmrad6(15)
...
c
     ...
     &             'SOA4_9    ','SOA4_10   ','SOA5_1    ',
     &             'SOA5_2    ','SOA5_3    ','SOA5_4    ',
     &             'SOA5_5    ','SOA5_6    ','SOA5_7    ',
     &             'SOA5_8    ','SOA5_9    ','SOA5_10   ',
     &             'SOA6_1    ','SOA6_2    ','SOA6_3    ',
     &             'SOA6_4    ','SOA6_5    ','SOA6_6    ',
     &             'SOA6_7    ','SOA6_8    ','SOA6_9    ',
     &             'SOA6_10   ','SOA7_1    ','SOA7_2    ',
     &             'SOA7_3    ','SOA7_4    ','SOA7_5    ',
     &             'SOA7_6    ','SOA7_7    ','SOA7_8    ',
     &             'SOA7_9    ','SOA7_10   ','SOPA_1    ',
     ...
     &             'PEC_5     ','PEC_6     ','PEC_7     ',
     &             'PEC_8     ','PEC_9     ','PEC_10    ',
     &             'CRST_1    ','CRST_2    ','CRST_3    ',
     &             'CRST_4    ','CRST_5    ','CRST_6    ',
     &             'CRST_7    ','CRST_8    ','CRST_9    ',
     &             'CRST_10   ','PH2O_1    ','PH2O_2    ',
     &             'PH2O_3    ','PH2O_4    ','PH2O_5    ',
     &             'PH2O_6    ','PH2O_7    ','PH2O_8    ',
     &             'PH2O_9    ','PH2O_10   ','PCL_1     ',
     &             'PCL_2     ','PCL_3     ','PCL_4     ',
     &             'PCL_5     ','PCL_6     ','PCL_7     ',
     &             'PCL_8     ','PCL_9     ','PCL_10    ',
     &             'NA_1      ','NA_2      ','NA_3      ',
     ...
     &             'PNH4_9    ','PNH4_10   ','PNO3_1    ',
     &             'PNO3_2    ','PNO3_3    ','PNO3_4    ',
     &             'PNO3_5    ','PNO3_6    ','PNO3_7    ',
     &             'PNO3_8    ','PNO3_9    ','PNO3_10   ',
     &             'PSO4_1    ','PSO4_2    ','PSO4_3    ',
     &             'PSO4_4    ','PSO4_5    ','PSO4_6    ',
     &             'PSO4_7    ','PSO4_8    ','PSO4_9    ',
     &             'PSO4_10   '/
c
      data fasts3 /'NO        ','NO2       ','O3        ',
     &             'PAN       '/
      data fasts5 /'NO        ','NO2       ','O3        ',
     &             'PAN       ','CRES      ','PAN2      ',
     &             'MPAN      ','PBZN      ','NPHE      ',
     &             'RNO3      ','DCB2      ','DCB3      ',
     &             'HNO4      '/
      data fasts6 /'NO        ','NO2       ','O3        ',
     &             'PAN       ','PANX      '/
c
...
c
     ...
     &             'CRO       '/
c
      data mchactv  /  1,  0,  1,  1,  1,  1,  0, 0, 0, 1 /
      data mchgas   / 34, 24, 25, 43, 75, 53,  0, 0, 0, 999 /
      data mchaero  /  0,  0,  0, 22, 22, 22,  0, 0, 0, 999 /
      data mchrad   / 14, 12, 12, 12, 18, 15,  0, 0, 0, 0 /
      data mchiessr /  4,  2,  2,  2,  2,  2,  0, 0, 0, 0 /
      data mchrxn   /110, 91, 96,113,217,156,  0, 0, 0, 0 /
      data mchphot  / 14, 11, 12, 17, 30, 23,  0, 0, 0, 0 /
      data mchfast  /  4,  4,  4,  4, 13,  5,  0, 0, 0, 0 /
...
c
     ...
     &                 ' following gas species to use the PM options:'
            ...
            write(iout,'(a)')' O3, NXOY, TOLA, XYLA, ISP, TRP, SQT,'
