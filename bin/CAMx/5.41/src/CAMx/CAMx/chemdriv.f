      subroutine chemdriv(m1,m2,m3,i0,j0,ia,iz,ja,jz,ibcon,igrd,ltuv,
     &                    ltuva,ncol,nrow,nlay,dt,itzon,idfin,fcloud,
     &                    cldtrns,water,tempk,press,height,cwc,cph,
     &                    conc,cellat,cellon,ldark,l3dflag,
...
c     Input arguments:
c        igrd                grid index
c        ltuv                In-line cloud TUV flag
c        ltuva               In-line aerosol TUV flag
...
c
     ...
     &                  ctrns,cldadj,ldark(i,j),ltuv,iabov,tcell,pcell)
c
