...
c  BZCO  CXO2  HCO3  TBUO   BZO  BZNO     I    NO   NO2    O3
c   PAN  PAN2  MPAN  PBZN  NPHE  CRES  DCB2  DCB3  RNO3  HNO4
c
c
     ...
     &                      +(-1.000)*r(156)
          ...
          jac(iI   ,iNO3 )= +( 1.000)*r(260)+(-1.000)*r(272)
     ...
     &                      +(-0.011)*r(200)+(-0.162)*r(213)
          ...
          jac(iI   ,iOH  )= +(-1.000)*r(271)+(-1.000)*r(283)
     &                      +(-0.180)*r(286)
     ...
     &                      +( 1.000)*r(122)
          ...
          jac(iNO3 ,iI   )= +( 1.000)*r(260)
          jac(iHO2 ,iI   )= +( 1.000)*r(257)
          jac(iI   ,iI   )= +( 1.000)*r(256)+( 1.000)*r(257)
     &                      +( 1.000)*r(258)+( 1.000)*r(259)
     &                      +( 1.000)*r(260)+( 1.000)*r(261)
     &                      +( 1.000)*r(262)
          jac(iNO  ,iI   )= +( 1.000)*r(258)+(-1.000)*r(261)
          jac(iNO2 ,iI   )= +( 1.000)*r(259)+(-1.000)*r(260)
     &                      +(-1.000)*r(262)
          jac(iO3  ,iI   )= +( 1.000)*r(256)
     ...
     &                      +(-1.000)*r( 51)+(-1.000)*r(128)
          ...
          jac(iI   ,iNO  )= +( 1.000)*r(258)+(-1.000)*r(264)
