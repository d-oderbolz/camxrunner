      subroutine ieslow8(r,rate,gain,loss,nr,ny,n1,n2)
      implicit none
c
c----CAMx v5.41 121109
c
c     IESLOW8 computes rates for IEH solver slow species
c
...
c   SO2  SULF  ETOH  MTBE  MBUT   CL2  HOCL  FMCL   HCL  NTCL
c  N3CL    SS    HI    I2   HOI  NBUI  CH3I   INO  INO2    IO
c   OIO  IXOY  INO3  HIO3  IBUO  IBAC
c
        Loss(iHONO )= +( 1.000)*r( 22)+( 1.000)*r( 23)+( 1.000)*r( 24)
c
        Gain(iHONO )= +( 1.000)*r( 21)
c
        Loss(iHNO3 )= +( 1.000)*r( 27)+( 1.000)*r( 28)+( 1.000)*r(255)
c
...
c
        Loss(iACET )= +( 1.000)*r(136)+( 1.000)*r(137)+( 1.000)*r(249)
c
     ...
     &                +( 0.072)*r(238)
c
        Loss(iMEK  )= +( 1.000)*r(138)+( 1.000)*r(139)+( 1.000)*r(250)
c
     ...
     &                +( 0.089)*r(238)
c
        Loss(iMEOH )= +( 1.000)*r(140)+( 1.000)*r(251)
c
...
c
        Gain(iETHE )= 0.0
c
        Loss(iALK1 )= +( 1.000)*r(197)+( 1.000)*r(234)
c
        Gain(iALK1 )= 0.0
c
        Loss(iALK2 )= +( 1.000)*r(198)+( 1.000)*r(235)
c
        Gain(iALK2 )= 0.0
c
        Loss(iALK3 )= +( 1.000)*r(199)+( 1.000)*r(236)
c
        Gain(iALK3 )= 0.0
c
        Loss(iALK4 )= +( 1.000)*r(200)+( 1.000)*r(237)
c
        Gain(iALK4 )= 0.0
c
        Loss(iALK5 )= +( 1.000)*r(201)+( 1.000)*r(238)
c
        Gain(iALK5 )= 0.0
c
        Loss(iARO1 )= +( 1.000)*r(202)+( 1.000)*r(244)
c
        Gain(iARO1 )= 0.0
c
        Loss(iARO2 )= +( 1.000)*r(203)+( 1.000)*r(245)
c
        Gain(iARO2 )= 0.0
c
...
c
        Loss(iETOH )= +( 1.000)*r(212)+( 1.000)*r(252)
c
        Gain(iETOH )= 0.0
c
...
c
        Gain(iMBUT )= 0.0
c
        Loss(iCL2  )= +( 1.000)*r(218)
c
        Gain(iCL2  )= +( 0.300)*r(221)+( 1.000)*r(228)
c
        Loss(iHOCL )= +( 1.000)*r(219)
c
        Gain(iHOCL )= +( 1.000)*r(223)
c
        Loss(iFMCL )= +( 1.000)*r(230)+( 1.000)*r(231)
c
        Gain(iFMCL )= +( 1.000)*r(239)+( 0.800)*r(240)+( 0.750)*r(241)
     &                +( 0.850)*r(242)+( 0.600)*r(243)
c
        Loss(iHCL  )= +( 1.000)*r(229)+( 1.000)*r(253)
c
        Gain(iHCL  )= +( 1.000)*r(232)+( 1.000)*r(233)+( 1.000)*r(234)
...
c
        Loss(iNTCL )= +( 1.000)*r(254)
c
        Gain(iNTCL )= +( 1.000)*r(253)
c
        Loss(iN3CL )= +( 1.000)*r(225)+( 1.000)*r(226)+( 1.000)*r(227)
     &                +( 1.000)*r(228)
c
        Gain(iN3CL )= +( 1.000)*r(224)
c
        Loss(iSS   )= +( 1.000)*r(255)
c
        Gain(iSS   )= 0.0
c
        Loss(iHI   )= +( 1.000)*r(283)
c
        Gain(iHI   )= +( 1.000)*r(257)
c
        Loss(iI2   )= +( 1.000)*r(270)+( 1.000)*r(271)+( 1.000)*r(272)
c
        Gain(iI2   )= +( 1.000)*r(261)+( 1.000)*r(262)
c
        Loss(iHOI  )= +( 1.000)*r(281)+( 1.000)*r(282)
c
        Gain(iHOI  )= +( 1.000)*r(266)+( 1.000)*r(271)
c
        Loss(iNBUI )= +( 1.000)*r(285)+( 1.000)*r(286)
c
        Gain(iNBUI )= 0.0
c
        Loss(iCH3I )= +( 1.000)*r(284)
c
        Gain(iCH3I )= 0.0
c
        Loss(iINO  )= +( 1.000)*r(261)
c
        Gain(iINO  )= +( 1.000)*r(258)
c
        Loss(iINO2 )= +( 1.000)*r(262)+( 1.000)*r(277)+( 1.000)*r(278)
c
        Gain(iINO2 )= +( 1.000)*r(259)
c
...
c
        Loss(iIXOY )= +( 1.000)*r(269)+( 1.000)*r(276)
c
        Gain(iIXOY )= +( 1.000)*r(268)+( 1.500)*r(269)+( 1.500)*r(276)
c
        Loss(iINO3 )= +( 1.000)*r(279)+( 1.000)*r(280)
c
        Gain(iINO3 )= +( 1.000)*r(265)+( 1.000)*r(272)
c
        Loss(iHIO3 )= 0.0
c
        Gain(iHIO3 )= +( 1.000)*r(275)
c
        Loss(iIBUO )= +( 1.000)*r(287)
c
        Gain(iIBUO )= +( 0.820)*r(286)
c
        Loss(iIBAC )= +( 1.000)*r(288)
c
        Gain(iIBAC )= +( 1.000)*r(287)
c
c
      do l=n1,n2
