...
c
      ...
      r(219) = rk(219)*yh(lI)*yh(lO3)
      r(220) = rk(220)*yh(lI)*yh(lHO2)
      r(221) = rk(221)*yh(lI)*yh(lNO)
      r(222) = rk(222)*yh(lI)*yh(lNO2)
      r(223) = rk(223)*yh(lI2)
      r(224) = rk(224)*yh(lI2)*yh(lOH)
      r(225) = rk(225)*yh(lI2)*yh(lNO3)
      r(226) = rk(226)*yh(lHI)*yh(lOH)
      r(227) = rk(227)*yh(lIO)
      r(228) = rk(228)*yh(lIO)*yh(lNO)
      r(229) = rk(229)*yh(lIO)*yh(lNO2)
      r(230) = rk(230)*yh(lIO)*yh(lHO2)
      r(231) = rk(231)*yh(lIO)*yh(lIO)
      r(232) = rk(232)*yh(lHOI)
      r(233) = rk(233)*yh(lHOI)*yh(lOH)
      r(234) = rk(234)*yh(lOIO)
      r(235) = rk(235)*yh(lOIO)*yh(lNO)
      r(236) = rk(236)*yh(lOIO)*yh(lOH)
      r(237) = rk(237)*yh(lOIO)*yh(lIO)
      r(238) = rk(238)*yh(lOIO)*yh(lOIO)
      r(239) = rk(239)*yh(lI2O2)
      r(240) = rk(240)*yh(lI2O2)*yh(lO3)
      r(241) = rk(241)*yh(lINO)*yh(lI)
      r(242) = rk(242)*yh(lINO)*yh(lINO)
      r(243) = rk(243)*yh(lINO2)
      r(244) = rk(244)*yh(lINO2)*yh(lINO2)
      r(245) = rk(245)*yh(lINO3)
      r(246) = rk(246)*yh(lINO3)*yh(lI)
      r(247) = rk(247)*yh(lCH3I)
      r(248) = rk(248)*yh(lMI2)
      r(249) = rk(249)*yh(lMIB)
      r(250) = rk(250)*yh(lMIC)
      r(251) = rk(251)*yh(lIALK)
c
      return
      end
