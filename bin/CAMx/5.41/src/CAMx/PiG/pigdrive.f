     ...
     &                    conc,pigdump,pgmserr,fluxes,depfld,
...
c$omp&          noxcnt,hinox,ij,iozon,ihaze,ialb,hght,iabov,
...
c
     ...
     &              cldadj,ldarkp,ltuv,iabov,tpuff,ppuff)
c
...
c-----Calculate the rate constant for heterogeneous hydrolysis of N2O5
c
          if (aero_flag.GT.0) call khetero(tpuff,wpuff,conpig(1,nr))
c
