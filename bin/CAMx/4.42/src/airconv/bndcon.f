...
C  SEGMENT ORIGIN AND SEGMENT SIZE
      READ(7,1002) (IX(I),IY(I), NXCLL(I), NYCLL(I),I=1,NSEG)
      WRITE(IOUT,5002) (IX(I),IY(I), NXCLL(I), NYCLL(I),I=1,NSEG)
      WRITE (9) (IX(I),IY(I),NXCLL(I),NYCLL(I),I=1,NSEG)
  10  CONTINUE
...
C
      DO 30 I=1,NRECS
         READ(7,1021)ISEGM,IEDGE,NCELLS,((ILOC(II,J),II=1,4),J=1,NCELLS)
         WRITE(IOUT,5021)ISEGM,IEDGE,NCELLS
         WRITE(9)      ISEGM,IEDGE,NCELLS,
...
C   FOR EACH EDGE
                DO 980 I=1,4
                  IF (I.GE.3) NCEL= NX
                  READ(7,1009) ISEGNM,(SPNAME(II,K),II=1,10),NEDGNO,
     &                ((BCONC(II,JJ),II=1,NZ),JJ=1,NCEL)                
                  WRITE(9)ISEGNM,(SPNAME(II,K),II=1,10),NEDGNO,
     &                ((BCONC(II,JJ),II=1,NZ),JJ=1,NCEL)
  980           CONTINUE
  985        CONTINUE
  990    CONTINUE
 ...
 2001 FORMAT(F10.4,1X,F10.4,1X,I3,F10.4,1X,F10.4,1X,2F7.0,5I4,3F7.0)
