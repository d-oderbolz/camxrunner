  ...
  200 continue
      write(ErrNum, 220) 'Error reading ikvcon file'
      write(*, 220) 'Error reading ikvcon file'
      stop

  210 continue
      write(ErrNum, 220) 'Error writing ikvcon file'
      write(*, 220) 'Error writing ikvcon file'
      stop
