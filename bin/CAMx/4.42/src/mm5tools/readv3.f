...
!   
!   f90 -free -convert big_endian -o readv3.o readv3.f
!
!   On a 32 bit linux
!   machine (llc5, llc6, merlin00), type the following to compile:
!   
!   pgf90 -Mfreeform -byteswapio -o readv3.o readv3.f
!
!   On a 64 bit linux
!   machine (lcsl5a), type the following to compile:
!   
!   pgf90 -Mfreeform -byteswapio -o readv3_64.o readv3.f
!
!
!   On SUN dom.cscs.ch (also for running on NEC/SX5) 
!   machine, type the following to compile:
!   
!   sxf90 -f4 readv3.f
!
