...
c
      ...
      include "filunit.com"
c
      integer ncol,nrow,nlay,nspc,igrd
c
c===========================DDM Begin=================================
c
      include "tracer.com"
...
c
      integer nsen,ls,isen,ioff
      real sens(ncol,nrow,nlay,nsen),tpsens(nsen)
...
c
      include "procan.com"
c
      integer ipa_xy(ncol,nrow),ipa_idx
...
c
      ...
      real conc(ncol,nrow,nlay,nspc),tpconc(nspc),tarray2(2)
     ...
     &     press(ncol,nrow,nlay),dx(nrow)
      ...
      real deltat,dy,densfac
c
      integer ispc,j,i1,i2,i,k
      real rho,rhom,drodz,rhop,convfac,tcpu,dtime
c
c-----Entry point
c
...
c
            ...
            rhop = rho + drodz*d1d(nlay)/2.
            convfac = densfac*273.*rhop/1013.
            if (ispc.gt.ngas .and. .not.losat) then
              convfac = 1.
            endif
            if( losat .AND. tectyp .NE. RTRAC .AND. 
     &                                      .NOT. lsagas(ispc) ) then
              convfac = 1.
            endif 
