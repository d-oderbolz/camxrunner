     ...
     &                        mxrad_c,con,cncrad,convfac,t00,dtaq,dtaer)
c
c----CAMx v4.42 070603
c
...
c        05/30/07 (cae)    Skip call to RAQCHEM under high acid conditions.
c
c     Input arguments:
...
c        mxrad_c             Max number of radicals
...
c
        do knsec=1,nsec
          ...
          q((knsec-1)*nsp+kcl+5)=con(ksoa5_c+(knsec-1))
...
c
        do knsec=1,nsec
          ...
          con(ksoa5_c+(knsec-1))=q((knsec-1)*nsp+kcl+5)
