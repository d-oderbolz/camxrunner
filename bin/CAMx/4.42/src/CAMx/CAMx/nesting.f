...
c
        do 99 it2=1,ntim(igrd0(igen))
          ...
          call chrtime(timec(igrd0(igen)),datec(igrd0(igen)),
     &                 chtime,chdate)
          call emistrns(igrd0(igen),chtime,chdate)
c
c-----Generation 3
c
...
c
                  igen=4
                  call uptime(timec(igrd0(igen)),
     &                        datec(igrd0(igen)),deltat(igrd0(igen)))
                  if (ipigflg .NE. 0) call pigevol(igrd0(igen))
