...
c
      ...
      character*4 ifile(10),note(60),smpspec(10,MXOUT)
      character*10 avfil
c
      data avfil /'AVERAGE   '/
...
c
        ...
        write(iunit) zero,zero,izone,orgx,orgy,dx,dy,ncols(nsg),
     &               nrows(nsg),ione,izero,izero,zero,zero,zero
        write(iunit) ione,ione,ncols(nsg),nrows(nsg)
