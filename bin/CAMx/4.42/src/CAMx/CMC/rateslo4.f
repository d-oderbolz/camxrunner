...
c  MEOH  ETOH  ISPD  OLE2   CG1   CG2   CG3   CG4   CG5
c
        Loss(kPAN  )= +( 1.000)*r( 48)+( 1.000)*r(113)
        Gain(kPAN  )= +( 1.000)*r( 47)
        Loss(kHNO3 )= +( 1.000)*r( 27)+( 1.000)*r(114)
     ...
     &                +( 1.000)*r(110)
        ...
        Loss(kPNA  )= +( 1.000)*r( 30)+( 1.000)*r( 31)+( 1.000)*r(117)
        Gain(kPNA  )= +( 1.000)*r( 29)
        Loss(kH2O2 )= +( 1.000)*r( 34)+( 1.000)*r( 35)+( 1.000)*r(107)
        Gain(kH2O2 )= +( 1.000)*r( 32)+( 1.000)*r( 33)+( 1.000)*r(105)
        Loss(kCO   )= +( 1.000)*r( 36)
     ...
     &                +( 1.000)*r(100)
        ...
        Gain(kCG1  )= +( 0.044)*r( 63)+( 0.027)*r( 72)

        Gain(kCG2  )= +( 0.085)*r( 63)+( 0.118)*r( 72)
     ...
     &                +( 0.136)*r(100)
        ...
        Gain(kCG5  )= +( 0.036)*r( 66)+( 0.036)*r( 67)
      do l=neq1+1,ngas
