      subroutine lsrate4(neq,t,y,rate)
c
c----CAMx v4.42 070603
c
...
c  XO2N   ROR   CG3   NTR   OLE   ETH   TOL  CRES   TO2   CG1
c   CG2  OPEN   CRO   CG5  MGLY   XYL  ISOP  ISPD   SO2  SULF
c  MEOH  ETOH  OLE2   CG4
c
     ...
     &                +( 1.000)*r( 94)+( 1.000)*r(100)+( 1.000)*r(108)
     &                +( 1.000)*r(109)+( 1.000)*r(110)+( 1.000)*r(111)
     &                +( 2.000)*r(112)
        Gain(lNO3  )= +( 1.000)*r(  5)+( 1.000)*r(  7)+( 1.000)*r( 19)
     &                +( 1.000)*r( 27)+( 1.000)*r(115)+( 0.390)*r(117)
        Loss(lO1D  )= +( 1.000)*r( 10)+( 1.000)*r( 11)+( 1.000)*r(101)
        Gain(lO1D  )= +( 1.000)*r(  9)
     ...
     &                +( 1.000)*r(103)+( 1.000)*r(107)+( 1.000)*r(109)
        Gain(lHO2  ) = Gain(lHO2  )
     &                +( 0.610)*r(117)
        Loss(lN2O5 )= +( 1.000)*r( 18)+( 1.000)*r( 19)+( 1.000)*r(115)
        Gain(lN2O5 )= +( 1.000)*r( 17)
        Loss(lHNO3 )= +( 1.000)*r( 27)+( 1.000)*r(114)
     ...
     &                +( 1.000)*r(110)
        ...
        Loss(lPNA  )= +( 1.000)*r( 30)+( 1.000)*r( 31)+( 1.000)*r(117)
        Gain(lPNA  )= +( 1.000)*r( 29)
        Loss(lH2O2 )= +( 1.000)*r( 34)+( 1.000)*r( 35)+( 1.000)*r(107)
        Gain(lH2O2 )= +( 1.000)*r( 32)+( 1.000)*r( 33)+( 1.000)*r(105)
        Loss(lCO   )= +( 1.000)*r( 36)
     ...
     &                +( 0.220)*r( 99)+( 0.910)*r(100)+( 1.000)*r(116)
        Loss(lPAN  )= +( 1.000)*r( 48)+( 1.000)*r(113)
     ...
     &                +( 1.000)*r( 59)
        ...
        Gain(lCG1  )= +( 0.044)*r( 63)+( 0.027)*r( 72)

        Gain(lCG2  )= +( 0.085)*r( 63)+( 0.118)*r( 72)
        ...
        Gain(lCG5  )= +( 0.036)*r( 66)+( 0.036)*r( 67)
     ...
     &                +( 0.200)*r( 78)+( 0.200)*r( 96)
        ...
        Loss(lOLE2 )= +( 1.000)*r( 97)+( 1.000)*r( 98)+( 1.000)*r( 99)
     &                +( 1.000)*r(100)


        Gain(lCG4  )= +( 0.136)*r( 97)+( 0.136)*r( 98)+( 0.136)*r( 99)
     &                +( 0.136)*r(100)
c
      do l=1,neq
