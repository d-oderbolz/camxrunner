...
c
      ...
      r( 97) = dbrk( 97)*y(lO)*y(lOLE2)
      r( 98) = dbrk( 98)*y(lOH)*y(lOLE2)
      r( 99) = dbrk( 99)*y(lO3)*y(lOLE2)
      r(100) = dbrk(100)*y(lNO3)*y(lOLE2)
      r(101) = dbrk(101)*y(lO1D)*H2
      r(102) = dbrk(102)*y(lOH)*H2
      r(103) = dbrk(103)*y(lOH)*y(lO)
      r(104) = dbrk(104)*y(lOH)*y(lOH)
      r(105) = dbrk(105)*y(lOH)*y(lOH)
      r(106) = dbrk(106)*y(lHO2)*y(lO)
      r(107) = dbrk(107)*y(lH2O2)*y(lO)
      r(108) = dbrk(108)*y(lNO3)*y(lO)
      r(109) = dbrk(109)*y(lNO3)*y(lOH)
      r(110) = dbrk(110)*y(lNO3)*y(lHO2)
      r(111) = dbrk(111)*y(lNO3)*y(lO3)
      r(112) = dbrk(112)*y(lNO3)*y(lNO3)
      r(113) = dbrk(113)*y(lPAN)
      r(114) = dbrk(114)*y(lHNO3)
      r(115) = dbrk(115)*y(lN2O5)
      r(116) = dbrk(116)*y(lNTR)
      r(117) = dbrk(117)*y(lPNA)
c
      return
      end
