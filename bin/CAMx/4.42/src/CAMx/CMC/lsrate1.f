      subroutine lsrate1(neq,t,y,rate)
c
c----CAMx v4.42 070603
c
c     LSRATE1 computes a full set of rates
c
...
c  MGLY   XYL  ISOP  ISPD   SO2  SULF  MEOH  ETOH   CL2    CL
c  HOCL   CLO   HCL  RCHO  FMCL  ICL1  ICL2  BUTA  BCL1  BCL2
c
c
     ...
     &                +( 1.000)*r(108)
        ...
        Loss(lPAR  )= +( 1.000)*r( 52)+( 1.000)*r(102)
     ...
     &                +( 0.090)*r( 59)+( 0.088)*r( 76)+( 0.130)*r(102)
        ...
        Gain(lROR  )= +( 0.760)*r( 52)+( 0.760)*r(102)
     ...
     &                +( 0.200)*r( 78)+( 0.200)*r( 96)
        ...
        Loss(lCL2  )= +( 1.000)*r( 97)
        Gain(lCL2  )= +( 0.300)*r(110)
        Loss(lCL   )= +( 1.000)*r( 99)+( 1.000)*r(102)+( 1.000)*r(103)
     &                +( 1.000)*r(104)+( 1.000)*r(105)+( 1.000)*r(106)
     &                +( 1.000)*r(108)
        Gain(lCL   )= +( 2.000)*r( 97)+( 1.000)*r( 98)+( 1.000)*r(100)
     &                +( 1.400)*r(110)
        Loss(lHOCL )= +( 1.000)*r( 98)
        Gain(lHOCL )= +( 1.000)*r(101)
        Loss(lCLO  )= +( 1.000)*r(100)+( 1.000)*r(101)+( 2.000)*r(110)
        Gain(lCLO  )= +( 1.000)*r( 99)

        Gain(lHCL  )= +( 1.000)*r(102)+( 1.000)*r(104)+( 0.150)*r(106)

        Gain(lRCHO )= +( 0.110)*r(102)+( 1.000)*r(103)

        Gain(lFMCL )= +( 1.000)*r(103)+( 1.000)*r(105)
        Loss(lICL1 )= +( 1.000)*r(107)
        Gain(lICL1 )= +( 0.280)*r(106)

        Gain(lICL2 )= +( 1.000)*r(107)
        Loss(lBUTA )= +( 1.000)*r(108)

        Loss(lBCL1 )= +( 1.000)*r(109)
        Gain(lBCL1 )= +( 0.700)*r(108)

        Gain(lBCL2 )= +( 1.000)*r(109)
c
      do l=1,neq
