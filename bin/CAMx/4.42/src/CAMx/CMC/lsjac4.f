      subroutine lsjac4(neq,t,y,ml,mu,rjac,nrjac)
c
c----CAMx v4.42 070603
c
c     LSJAC4 computes a full Jacobian for LSODE
c
...
c
     ...
     &                      +(-1.000)*r(111)+(-4.000)*r(112)
          JAC(lNO2 ,lOH  )= +(-1.000)*r( 24)+( 1.000)*r( 26)
     &                      +(-1.000)*r( 31)+(-1.000)*r(109)
          JAC(lNO2 ,lHO2 )= +(-1.000)*r( 28)+( 1.000)*r( 29)
          JAC(lNO2 ,lN2O5)= +(-1.000)*r( 19)+(-1.000)*r(115)
          JAC(lNO2 ,lHNO3)= +(-1.000)*r(114)
     ...
     &                      +(-0.610)*r(117)
          ...
          JAC(lNO2 ,lPAN )= +(-1.000)*r( 48)+(-1.000)*r(113)
          JAC(lNO2 ,lROR )= +( 1.000)*r( 55)
          JAC(lNO2 ,lNTR )= +(-1.000)*r(116)
     ...
     &                      +( 1.000)*r(103)+( 1.000)*r(106)
     &                      +( 1.000)*r(107)+( 1.000)*r(108)
          JAC(lO   ,lO3  )= +(-1.000)*r(  8)
          JAC(lO   ,lNO3 )= +(-0.890)*r( 14)+( 1.000)*r(108)
          JAC(lO   ,lO1D )= +(-1.000)*r( 10)
          JAC(lO   ,lOH  )= +( 1.000)*r(103)+(-2.000)*r(104)
          JAC(lO   ,lHO2 )= +( 1.000)*r(106)
          JAC(lO   ,lH2O2)= +( 1.000)*r(107)
     ...
     &                      +( 1.000)*r( 16)+( 1.000)*r( 17)
          ...
          JAC(lNO3 ,lO   )= +(-1.000)*r(  5)+( 1.000)*r(108)
          JAC(lNO3 ,lO3  )= +(-1.000)*r(  7)+( 1.000)*r(111)
          JAC(lNO3 ,lNO3 )= +( 1.000)*r( 14)+( 1.000)*r( 15)
     &                      +( 1.000)*r( 16)+( 1.000)*r( 17)
     &                      +( 1.000)*r( 41)+( 1.000)*r( 44)
     &                      +( 1.000)*r( 59)+( 1.000)*r( 67)
     &                      +( 1.000)*r( 78)+( 1.000)*r( 94)
     &                      +( 1.000)*r(100)+( 1.000)*r(108)
     &                      +( 1.000)*r(109)+( 1.000)*r(110)
     &                      +( 1.000)*r(111)+( 4.000)*r(112)
          JAC(lNO3 ,lOH  )= +(-1.000)*r( 27)+( 1.000)*r(109)
          JAC(lNO3 ,lHO2 )= +( 1.000)*r(110)
          JAC(lNO3 ,lN2O5)= +(-1.000)*r( 19)+(-1.000)*r(115)
          JAC(lNO3 ,lHNO3)= +(-1.000)*r( 27)
          JAC(lNO3 ,lPNA )= +(-0.390)*r(117)
     ...
     &                      +(-1.000)*r(106)
          JAC(lOH  ,lHNO3)= +( 1.000)*r( 27)+(-1.000)*r(114)
          JAC(lOH  ,lHONO)= +(-1.000)*r( 23)+( 1.000)*r( 24)
          JAC(lOH  ,lPNA )= +( 1.000)*r( 31)+(-0.390)*r(117)
     ...
     &                      +(-0.925)*r( 94)+(-1.000)*r(109)
     &                      +( 1.000)*r(110)
          JAC(lHO2 ,lO1D )= +(-1.000)*r(101)
     ...
     &                      +( 1.000)*r(106)+( 1.000)*r(110)
          JAC(lHO2 ,lPNA )= +(-1.000)*r( 30)+(-0.610)*r(117)
          JAC(lHO2 ,lH2O2)= +(-1.000)*r( 35)+(-1.000)*r(107)
     ...
     &                      +(-1.000)*r(110)
          ...
          JAC(lHNO3,lHO2 )= +(-1.000)*r(110)
          JAC(lHNO3,lN2O5)= +(-2.000)*r( 18)
          JAC(lHNO3,lHNO3)= +( 1.000)*r( 27)+( 1.000)*r(114)
     ...
     &                      +( 1.000)*r(117)
          JAC(lH2O2,lO   )= +( 1.000)*r(107)
          JAC(lH2O2,lOH  )= +( 1.000)*r( 35)+(-2.000)*r(105)
     ...
     &                      +( 4.000)*r( 49)+( 1.000)*r( 50)
          JAC(lC2O3,lPAN )= +(-1.000)*r( 48)+(-1.000)*r(113)
     ...
     &                      +(-0.220)*r( 99)+(-0.910)*r(100)
          ...
          JAC(lPAN ,lPAN )= +( 1.000)*r( 48)+( 1.000)*r(113)
     ...
     &                      +(-0.200)*r( 72)
          ...
          JAC(lCG1 ,lOH  )= +(-0.044)*r( 63)+(-0.027)*r( 72)
          JAC(lCG1 ,lTOL )= +(-0.044)*r( 63)
          JAC(lCG1 ,lXYL )= +(-0.027)*r( 72)
          JAC(lCG2 ,lOH  )= +(-0.085)*r( 63)+(-0.118)*r( 72)
          JAC(lCG2 ,lTOL )= +(-0.085)*r( 63)
          JAC(lCG2 ,lXYL )= +(-0.118)*r( 72)
     ...
     &                      +( 1.000)*r( 71)
          ...
          JAC(lCG5 ,lNO3 )= +(-0.036)*r( 67)
          JAC(lCG5 ,lOH  )= +(-0.036)*r( 66)
          JAC(lCG5 ,lCRES)= +(-0.036)*r( 66)+(-0.036)*r( 67)
