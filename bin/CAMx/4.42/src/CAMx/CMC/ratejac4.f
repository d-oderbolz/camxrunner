...
c
     ...
     &                +( 1.000)*r(100)+( 1.000)*r(108)+( 1.000)*r(109)
     &                +( 1.000)*r(111)+( 2.000)*r(112)+( 1.000)*r(113)
     &                +( 1.000)*r(114)+( 1.000)*r(115)+( 1.000)*r(116)
        Gain(kNO2  ) = Gain(kNO2  )
     &                +( 0.610)*r(117)
...
c   PAN
c
        Loss(kPAN  )= +( 1.000)*r( 48)+( 1.000)*r(113)
        Gain(kPAN  )= +( 1.000)*r( 47)

          JAC(kNO2 ,kPAN )= +(-1.000)*r( 48)+(-1.000)*r(113)

          JAC(kPAN ,kNO2 )= +(-1.000)*r( 47)

          JAC(kPAN ,kPAN )= +( 1.000)*r( 48)+( 1.000)*r(113)
      endif
c
