...
c   O1D
c
        Loss(iO1D  )= +( 1.000)*r( 10)+( 1.000)*r( 11)+( 1.000)*r(101)
        Gain(iO1D  )= +( 1.000)*r(  9)
...
c
     ...
     &                      +( 1.000)*r(115)
          JAC(iNO3 ,iN2O5)= +(-1.000)*r( 19)+(-1.000)*r(115)
          JAC(iNO2 ,iN2O5)= +(-1.000)*r( 19)+(-1.000)*r(115)
     ...
     &                      +(-1.000)*r(111)+(-4.000)*r(112)
          JAC(iO3  ,iNO3 )= +( 1.000)*r(111)

          JAC(iNO3 ,iOH  )= +(-1.000)*r( 27)+( 1.000)*r(109)
     ...
     &                      +( 1.000)*r( 68)+( 1.000)*r( 96)
          ...
          JAC(iNO3 ,iO3  )= +(-1.000)*r(  7)+( 1.000)*r(111)
     ...
     &                      +( 1.000)*r(111)
          ...
          JAC(iC2O3,iPAN )= +(-1.000)*r( 48)+(-1.000)*r(113)
          JAC(iNO2 ,iPAN )= +(-1.000)*r( 48)+(-1.000)*r(113)
          JAC(iPAN ,iPAN )= +( 1.000)*r( 48)+( 1.000)*r(113)
c
