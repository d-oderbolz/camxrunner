...
C     ho2tmp is reaction of HO2 with RO2s, used below
C
      ho2tmp = R(47)+R(52)+R(63)+R(118)+R(121)+
...
C...  OH + O3 (accounting for fraction of HO2 recycled via NO)
      PA(nn) =  PA(nn) 
     &       - R(36) * ( 2.*(R(37)+R(38))+R(43)+ho2tmp )
     &               / ( 2.*(R(37)+R(38))+R(43)+ho2tmp+R(31) )
C...  O(3P) + VOC
      PA(nn) =  PA(nn) 
     &       - ( R(164)+R(168)+R(188)+R(192)+R(196)+R(207)+R(211) )
C...  O3 + VOC
      PA(nn) =  PA(nn) 
     &       - ( R(162)+R(167)+R(179)+R(186)
     &                               +R(190)+R(194)+R(205)+R(209) )
C
...
C
C...  Fractional yield of HO2 from CCO3
...
C     108 MCO3 RO2R = 1 RC2H
     ...
     &                ( r(51)+r(52)+r(53)+r(54)+r(55)+r(60)+r(66)
...
C     111 MCO3 CCO3 = 1 CXO2 1 HCHO 1 CCO3
      cxo2_frac_cco3 = ( r(71)+r(73)+r(78)+r(88)+r(99)+r(111) ) /
...
C     112 MCO3 RCO3 = 1 HCHO 1 CCO3 1 CCHO
      ro2r_frac_rco3 = ( r(81)+r(83)+r(88)+r(89)+r(100) ) /
...
C     114 MCO3 MCO3 = 2 HCHO 2 CCO3
      cco3_frac_mco3 = ( r(104)+r(106)+r(109)+r(111)+r(112)+2*r(114) ) /
...
C    169 MVK = 0.3 CXO2 0.7 CO 0.7 PROD
      HO2_new = HO2_new 
     &            + ( r(131)+r(137)+0.3*r(169) ) * ho2_frac_ro2r
C
C...new HO2 via CCO3 from ACET, MEK, MGLY, BACL, ISPD, DCB2, DCB3  photolysis
C    137 ACET = 1 CCO3 1 CXO2
...
C    183 DCB3 = 1 RO2R 0.5 CCO3 0.5 HO2
      HO2_new = HO2_new 
     &            + ( r(137)+r(139)+2.0*r(152)+0.467*r(173)+0.5*r(181)
     &                 + 0.5*r(183) ) * ho2_frac_cxo2 * cxo2_frac_cco3
C
...
C    183 DCB3 = 1 RO2R 0.5 CCO3 0.5 HO2
      HO2_new = HO2_new 
     &            + ( r(134)+r(139)+0.33*r(165)
     &                   + 0.96*r(175)+r(181)+r(183) ) * ho2_frac_ro2r
C
...
C    210 OLE2 NO3 = 0.391 NO2 0.442 RO2R 0.136 RO2N
      HO2_new = HO2_new 
     &            + ( 0.5*r(163)+0.799*r(172)+r(187)+0.749*r(191)
     &                  + 0.276*r(195)+0.824*r(206)+0.442*r(210) )
     &                                                 * ho2_frac_ro2r
C
...
C...  HO2 reacted
     ...
     &                +( 1.000)*r(126)! 126 HCHO HO2 = 1 HCO3
C
