...
c
      ...
      call nodes_pass(itopc,1,MPI_INTEGER,itag,numprocs,iproc_id)
...
c
      ...
      call nodes_pass(bdlrad,1,MPI_REAL,itag,numprocs,iproc_id)
      ...
      call nodes_pass(krad,NRADNM,MPI_INTEGER,itag,numprocs,iproc_id)
...
c
      ...
      call nodes_pass(knxoy_c,1,MPI_INTEGER,itag,numprocs,iproc_id)
...
c
      ...
      call nodes_pass(rk,nreact,MPI_REAL,itag,numprocs,iproc_id)
     ...
     &                                              numprocs,iproc_id)
      call nodes_pass(lradmap,nspec+nrad,MPI_INTEGER,itag,numprocs,iproc_id)
     ...
     &                                MPI_REAL,itag,numprocs,iproc_id)
      ...
      if (lchem) call nodes_pass(nmrad,10*(nrad+1),MPI_CHARACTER,itag,
     &                                               numprocs,iproc_id)
c
...
c
      call nodes_pass(rgso,NLU*5,MPI_REAL,itag,numprocs,iproc_id)
      call nodes_pass(z0lu,NLU*5,MPI_REAL,itag,numprocs,iproc_id)
      call nodes_pass(rj,NLU*5,MPI_REAL,itag,numprocs,iproc_id)
      call nodes_pass(rlu,NLU*5,MPI_REAL,itag,numprocs,iproc_id)
      call nodes_pass(rac,NLU*5,MPI_REAL,itag,numprocs,iproc_id)
      call nodes_pass(rlcs,NLU*5,MPI_REAL,itag,numprocs,iproc_id)
      call nodes_pass(rlco,NLU*5,MPI_REAL,itag,numprocs,iproc_id)
      call nodes_pass(rgss,NLU*5,MPI_REAL,itag,numprocs,iproc_id)
...
c
      call nodes_pass(lrad,NRADNM,MPI_INTEGER,itag,numprocs,iproc_id)
...
c
      if( iproc_id .GT. 0) then
         ...
         elseif ( tectyp .EQ. RTCMC ) then
            call alloc_rtracchm(ngrid,mmxp,mmyp,nspec,ntotsp)
            call alloc_rtcmc(MXTRSP,MXSPEC,MXRADCL,MXRX,
...
c
     ...
     &                                         1, 1, ntotsp, ispc, itag)
      ...
      call nodes_pass(ptloft,ntotsp,MPI_REAL,itag,numprocs,iproc_id)
c
...
c
      ...
      elseif( tectyp .EQ. RTCMC ) then
          ...
          call nodes_pass(itypsp,MXTRSP+MXSPEC+MXRADCL,MPI_INTEGER,itag,numprocs,iproc_id)
          call nodes_pass(itypschm,MXTRSP+MXSPEC+MXRADCL,MPI_INTEGER,itag,numprocs,iproc_id)
          ...
          call nodes_pass(conschm,MXTRSP+MXSPEC+MXRADCL,MPI_REAL,itag,numprocs,iproc_id)
          call nodes_pass(depvschm,MXTRSP+MXSPEC+MXRADCL,MPI_REAL,itag,numprocs,iproc_id)
          call nodes_pass(wetschm,MXTRSP+MXSPEC+MXRADCL,MPI_REAL,itag,numprocs,iproc_id)
          ...
          call nodes_pass(spnmrt,MXTRSP+MXSPEC+MXRADCL,MPI_CHARACTER,itag,numprocs,iproc_id)
          call nodes_pass(spnmschm,MXTRSP+MXSPEC+MXRADCL,MPI_CHARACTER,itag,numprocs,iproc_id)
          ...
          call nodes_pass(idxfix,MXTRSP+MXSPEC+MXRADCL,MPI_INTEGER,itag,numprocs,iproc_id)
      endif
c
c========================= Probing Tools End =======================
c
...
c
         ...
         call nodes_pass(nradddm,  1,MPI_INTEGER,itag,numprocs,iproc_id)
