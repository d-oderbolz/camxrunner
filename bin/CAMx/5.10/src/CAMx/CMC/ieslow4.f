...
c-----CAMx v5.10 090918
c
c     IESLOW4 computes rates for IEH solver slow species
c
...
c  ETOH  ISPD
c
        Loss(iHNO3 )= +( 1.000)*r( 27)+( 1.000)*r(110)
c
...
c
        Loss(iPNA  )= +( 1.000)*r( 30)+( 1.000)*r( 31)+( 1.000)*r(113)
c
        Gain(iPNA  )= +( 1.000)*r( 29)
c
        Loss(iH2O2 )= +( 1.000)*r( 34)+( 1.000)*r( 35)+( 1.000)*r(103)
c
        Gain(iH2O2 )= +( 1.000)*r( 32)+( 1.000)*r( 33)+( 1.000)*r(101)
c
        Loss(iCO   )= +( 1.000)*r( 36)
c
