      subroutine ierate4(neq,t,y,rate,nr,r)
      use lsbox
      implicit none
c
c-----CAMx v5.10 090918
c
c     IERATE4 computes rates for IEH solver fast species
c
...
c    NO   NO2    O3   PAN
c
        Loss(iN2O5 )= +( 1.000)*r( 18)+( 1.000)*r( 19)+( 1.000)*r(111)
c
...
c
        Gain(iO3   )= +( 1.000)*r(  2)
c
        Loss(iPAN  )= +( 1.000)*r( 48)+( 1.000)*r(109)
c
