      ...
      do i = 1, nrxnrtc
         if( nrct(i) .GT. 0 ) then
            do j = 1, nrct(i)
               ...
               if ( .NOT. lhit ) then
                  ngasrtc = ngasrtc + 1
                  if( ngasrtc .GT. MXTRSP+MXSPEC+MXRADCL ) goto 7002
...
c
 ...
 100  read (iinp, '(A)', end=8001, err=8000) line
      ...
      if( letr .EQ. '#' ) then
         ...
         isp = isp+1
         if( isp .GT. MXTRSP+MXSPEC+MXRADCL ) goto 7002
