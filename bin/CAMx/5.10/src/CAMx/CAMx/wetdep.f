     ...
     &                  pwg,cph,densfac,idfin,conc,fluxes,depfld,
     &                  wetfld,dtout,ipa_cel,iptrsa)
      use chmstry
      use bndary
      use procan
      use tracer
...
c
      ...
      integer nspcs,nspdep,igrd,j,jycl,i1,i2,i,ixcl,kbot,ktop,
     ...
     &     ascavc,qt,vt,cwat,pwat,rconst,area,volume
...
cgwilsonc$omp&  private(i,ixcl,kbot,ktop,k,ncnt,volrat,
cgwilsonc$omp&          rr,pp,ltop,kzcl,lcloud,lgraupl,cellvol,rainvol,
cgwilsonc$omp&          rhoair,l,c0trac,tmtrac,delcls,concls,cytcls,
cgwilsonc$omp&          c0cls,hlaw,cwat,pwat,delc,delm,tmass,c0,convfac,
cgwilsonc$omp&          cmin,gscav,ascav,c00,totc,totw,ceq,cyctr,
cgwilsonc$omp&          fc2r,fr2c,levap,lzerc,ipa_idx,isemptyf,
cgwilsonc$omp&          isemptyc,qtf,qtc,vtf,vtc,psizec,ascavf,
cgwilsonc$omp&          roprta,psize,ascavc,delr,kwtr,isec,isempty,
cgwilsonc$omp&          qt,vt,iaero,area,volume)
c
...
c
     ...
     &                     tempk(i,j,k),cwat,depth(i+i0,j+j0,k),rhoair,
...
c
     ...
     &                         tempk(i,j,k),0.,depth(i+i0,j+j0,k),
