      subroutine scavrat(laero,lcloud,lgraupl,tamin,pmm,temp,cwat,dz,
     &                   rhoair,conc,hlaw,difrat,rscale,
     &                   prtdia,rhoprt,gscav,ascav)
c
c----CAMx v5.10 090918
c 
...
c
     ...
     &     expo,reynold,power,scf,difbrwn,schmidt,stoke,top,bot,star,
