...
c
     ...
     &            i1(igrd),j1(igrd),i2(igrd),j2(igrd),nmesh(igrd),
     &            deltax(1,igrd),deltay(igrd),ptdryfld(ipsa2d(igrd)),
     &            deltax(1,ip),deltay(ip),ptdryfld(ipsa2d(ip)) )
            call aggdep(ncol(igrd),nrow(igrd),ncol(ip),nrow(ip),ntotsp,
     &            i1(igrd),j1(igrd),i2(igrd),j2(igrd),nmesh(igrd),
     &            deltax(1,igrd),deltay(igrd),ptwetfld(ipsa2d(igrd)),
     &            deltax(1,ip),deltay(ip),ptwetfld(ipsa2d(ip)) )
         endif
      endif
c
