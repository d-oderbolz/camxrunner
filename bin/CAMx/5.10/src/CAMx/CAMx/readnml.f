...
c
     ...
     & PiG_Submodel,Probing_Tool,Chemistry,Super_Stepping,
     & Dry_Deposition,Wet_Deposition,ACM2_Diffusion,Staggered_Winds,
...
c
      if( lsample ) then
        ipsmp(1) = 1
        do i = 2,nsample
          ipsmp(i) = ipsmp(i-1) + ncolsmp(i-1)*nrowsmp(i-1)*nspec
        enddo
c
