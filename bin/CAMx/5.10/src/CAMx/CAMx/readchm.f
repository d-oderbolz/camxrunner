...
c
c----If using the LSODE solver, allocate the arrays needed
c
      if( idsolv .EQ. IDLSOD .OR. idsolv .EQ. IDIEH .OR. ipigflg .GT. 0) 
     &                               call alloc_lsbox(nreact,nspec,nrad)
c
