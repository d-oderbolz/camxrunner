...
c
     ...
     &             ncol(1),nrow(1),nlay(1),nlayav,navspc,nspec,nrad,
     &                  lavmap,lradmap,lgas,tempk(1),press(1),conc(1),
     &                                  cncrad(1),avcnc(1),ipacl_3d(1))
c
c  --- Add PiG masses to average ---
c
      if (ipigflg .NE. 0 .AND. LVISPIG) then
         call avepig(1,deltat(1)/2.0,ncol(1),nrow(1),nlay(1),nlayav,
...
c
     ...
     &                ncol(1),nrow(1),nlay(1),1,ntotsp,ntotsp,nrad,
     &                      lsamap,lradmap,lsagas,tempk(1),press(1),
     &                        ptconc(1),cncrad(1),ptavrg(1),ipacl_3d(1))
         endif
c
...
c
     ...
     &                     i0,j0,ntotsp,deltat(igrd)/2.0,deltax(1,igrd),
