...
c        numrads    I  number of radical species
c     Output:  
c
c-----------------------------------------------------------------------
...
c
         ...
         allocate( depsp   (4*(numspcs+numrads)) )
c
         allocate( lbcmap  (numspcs) )
         allocate( lavmap  (numspcs+numrads) )
         allocate( licmap  (numspcs,numgrds) )
         allocate( larmap  (numspcs,numgrds) )
         allocate( lptmap  (numspcs) )
         allocate( lradmap (numspcs+numrads) )
         allocate( ldepmap (numspcs+numrads) )
c
...
c
c-----------------------------------------------------------------------
c   BEGIN SUBROUTINE ALLOC_CHMSTRY_RAD
c-----------------------------------------------------------------------
c
         subroutine alloc_chmstry_rad(numrads)
c
c-----------------------------------------------------------------------
c    Modules used:
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
c
         allocate( nmrad   (numrads+1) )
c
         return
         end subroutine
c
c-----------------------------------------------------------------------
c   END SUBROUTINE ALLOC_CHMSTRY_RAD
c-----------------------------------------------------------------------
c
c-----------------------------------------------------------------------
