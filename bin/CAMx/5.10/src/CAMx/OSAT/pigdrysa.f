c*** PIGDRYSA
c
      subroutine pigdrysa(ncolx,nrowy,nspc,ntrac,icell,jcell,
     &                                         idxpig,deldry,dryfld)
      use grid
      use pigsty
      use tracer
      implicit none
...
c
     ...
     &                   dryfld(icell,jcell,i) + 
     &                      deldry(ispc) * fluxmap(ispc,icls) *
     &                          dryfld(icell,jcell,i) / sumcls(icls)
                  enddo
                endif
              enddo
          endif
