...
c
      ...
      real    val
c
      real consum(MXCELLS,MXCELLS,MXTRCLS)
      real vdsum(MXCELLS,MXCELLS,MXTRCLS)
c
...
c
      ...
      call zeros(consum,MXCELLS*MXCELLS*MXTRCLS)
      call zeros(vdsum,MXCELLS*MXCELLS*MXTRCLS)
c
