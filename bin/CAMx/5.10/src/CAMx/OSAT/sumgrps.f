      subroutine sumgrps(ndlast,ttlast,emstot,emslft,emsbas,
     &                                          emsoth,emssum,lemit)
      use filunit
      use grid
      use chmstry
...
c
                ...
                if( idx .LE. 0 ) goto 30
c
                call sum1grd(igroup,igrid,idx,emssum,emsgrd,emsbas,
     &                                     emsoth,emslft,emstot,lemit)
c
c   --- next species ---
c
  30        continue
...
c
     ...
     &                                 emstot,emspnt,emssum,izcel,lemit)
c
c   --- next species ---
c
  60     continue
