...
c-----------------------------------------------------------------------
c
      character*10 namecls(MXALCLS,*)
      integer      numcls(MXALCLS)
      real         coefcon(MXALCLS,*)
      real         coeflux(MXALCLS,*)
      character*10 nameyld(MXALCLS,*)
...
c
     ...
     &           86.13    ,    64.06    ,    46.01    ,     46.01   ,
     &           46.01    ,    46.01    ,    46.01    ,     46.01   ,
     &           46.01    ,    46.01    ,    63.01    ,     17.03   ,
     &           92.0     ,   106.0     ,    68.0     ,    136.0    ,
     &          204.0     ,   150.0     ,   150.0     ,    130.0    ,
     &          130.0     ,   180.0     ,   180.0     ,    210.0    ,
