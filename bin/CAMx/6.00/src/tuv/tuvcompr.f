...
c
       parameter (nozn=5,nalb=5,nhaze=3,mxhght=11,nzen=10,mxrxn=24)
       real   rk1(nzen,mxrxn,mxhght,nhaze,nalb,nozn)
       real   rk2(nzen,mxrxn,mxhght,nhaze,nalb,nozn)
       real   camxozn(nozn), camxhaze(nhaze) 
...
c** ENTRY POINT
       ...
       write (*, '(A)') 'Number of altitudes on files'
       read (*, '(20x,i10)') nhght
       write (*, *) nhght
