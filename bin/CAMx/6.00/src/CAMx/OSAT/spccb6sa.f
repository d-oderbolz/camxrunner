c**** SPCCB6SA
c
      subroutine spccb6sa(namecls,numcls,coefcon,coeflux,
...
c
      do i=1,nspec
        molwt(i) = 1.0
        do j=1,NUMCB6
           if( spname(i) .EQ. cb6nam(j) ) molwt(i) = wtcb6(j)
        enddo
      enddo
c
c  ---- NOx species ---
...
c
          ...
          namecls(ITRNTR,4) = 'CRPX'
          coefcon(ITRNTR,4) = 1.0
          coeflux(ITRNTR,4) = 1.0
c
c  ---- PN3 species ---
c
          numcls(ITRPN3) = 1
