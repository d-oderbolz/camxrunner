     ...
     &                    endtim,enddate,numprocs,iproc_id)
c
c-----------------------------------------------------------------------
c    Modules used:
c-----------------------------------------------------------------------
...
c
         do igrd=1,ngrid
            if (iproc_id .eq. 0) then    
               call master_send_gridded_data(albedo(iptr2d(igrd)),igrd,1,1,itag)  
            else
               call node_recv_gridded_data(albedo(iptr2d(igrd)),igrd,1,1,itag)
            endif
            itag = itag+1
            if (iproc_id .eq. 0) then  
