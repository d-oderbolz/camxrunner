      subroutine iejac8(neq,t,y,ml,mu,jac,njac)
      implicit none
c
c----CAMx v6.00 130506
c
c     IEJAC8 computes a Jacobian for the IEH solver
c
...
c    CL
c
        Loss(iCL   )= +( 1.000)*r(220)+( 1.000)*r(228)+( 1.000)*r(232)
...
c
        Gain(iCL   )= +( 2.000)*r(218)+( 1.000)*r(219)+( 1.400)*r(221)
...
c   CLO
c
        Loss(iCLO  )= +( 2.000)*r(221)+( 1.000)*r(222)+( 1.000)*r(223)
     &                +( 1.000)*r(224)
c
        Gain(iCLO  )= +( 1.000)*r(220)+( 1.000)*r(225)+( 1.000)*r(226)
c
...
c     I
c
        Loss(iI    )= +( 1.000)*r(256)+( 1.000)*r(257)+( 1.000)*r(258)
     &                +( 1.000)*r(259)+( 1.000)*r(260)+( 1.000)*r(261)
     &                +( 1.000)*r(262)
c
        Gain(iI    )= +( 1.000)*r(263)+( 1.000)*r(264)+( 1.000)*r(267)
...
c    IO
c
        Loss(iIO   )= +( 1.000)*r(263)+( 1.000)*r(264)+( 1.000)*r(265)
     &                +( 1.000)*r(266)+( 2.000)*r(267)+( 2.000)*r(268)
     &                +( 1.000)*r(269)
c
        Gain(iIO   )= +( 1.000)*r(256)+( 1.000)*r(260)+( 1.000)*r(274)
...
c   OIO
c
        Loss(iOIO  )= +( 1.000)*r(273)+( 1.000)*r(274)+( 1.000)*r(275)
     &                +( 1.000)*r(276)
c
        Gain(iOIO  )= +( 1.000)*r(267)
c
...
c
     ...
     &                      +( 1.000)*r(271)+( 1.000)*r(275)
     &                      +( 1.000)*r(282)+( 1.000)*r(283)
     &                      +( 1.000)*r(286)+( 1.000)*r(287)
     ...
     &                      +( 1.000)*r(126)+( 1.000)*r(223)
     &                      +( 1.000)*r(257)+( 1.000)*r(266)
     ...
     &                      +( 1.000)*r(128)+( 1.000)*r(222)
     &                      +( 1.000)*r(258)+( 1.000)*r(264)
     ...
     &                      +( 1.000)*r(224)+( 1.000)*r(259)
          jac(iNO2 ,iNO2 )=jac(iNO2 ,iNO2 )
     &                      +( 1.000)*r(265)
