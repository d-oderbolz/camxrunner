      subroutine ierate8(neq,t,y,rate,nr,r)
      implicit none
c
c----CAMx v6.00 130506
c
c     IERATE8 computes rates for IEH solver fast species
c
...
c
        Loss(iN2O5 )= +( 1.000)*r( 12)+( 1.000)*r( 13)+( 1.000)*r(253)
c
...
c
        Gain(iTBUO )= +( 0.236)*r(199)+( 0.016)*r(213)+( 0.236)*r(236)
c
