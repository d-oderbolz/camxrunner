      subroutine iejac9(neq,t,y,ml,mu,jac,njac)
      implicit none
c
c----CAMx v6.00 130506
c
c     IEJAC9 computes a Jacobian for the IEH solver
c
...
c
     ...
     &                      +( 1.000)*r(154)+( 1.000)*r(168)
     &                      +( 1.000)*r(169)+( 1.000)*r(205)
     &                      +( 1.000)*r(209)+( 1.000)*r(216)
     &                      +( 1.000)*r(217)+( 1.000)*r(220)
     &                      +( 1.000)*r(221)
     ...
     &                      +( 1.000)*r(161)+( 1.000)*r(192)
     &                      +( 1.000)*r(198)+( 1.000)*r(208)
