...
c        B = 0.0
     ...
     &     r( 60)+r( 61)+r( 63)+r( 64)+r( 66)+r( 67)+r( 68) )
        ...
        Gain(kCAS2 )= +(0.0244*(1-B) + 0.0122*B )*r(200)
        Gain(kCAS2 )= +Gain(kCAS2 )+(0.1426*(1-B) + 0.0713*B )*r(201)
        Gain(kCAS1 )= +(0.0335*(1-B) + 0.0013*B )*r(202) !APT
        Gain(kCAS2 )= +Gain(kCAS2 )+(0.1005*(1-B) + 0.0737*B )*r(202)
        Gain(kCAS3 )= +(0.1675*(1-B) + 0.1340*B )*r(202)
        Gain(kCAS4 )= +(0.2344*(1-B) + 0.1942*B )*r(202)
        Gain(kCAS1 )= +Gain(kCAS1 )+(0.0380*(1-B) + 0.0008*B )*r(203)
        Gain(kCAS2 )= +Gain(kCAS2 )+(0.1519*(1-B) + 0.0987*B )*r(203)
        Gain(kCAS3 )= +Gain(kCAS3 )+(0.1899*(1-B) + 0.1519*B )*r(203)
        Gain(kCAS4 )= +Gain(kCAS4 )+(0.2658*(1-B) + 0.2203*B )*r(203)
        Gain(kCAS1 )= +Gain(kCAS1 )+(0.0012*(1-B) + 0.0002*B )*r(204)
     &                +(0.0012*(1-B) + 0.0002*B )*r(205)
     &                +(0.0012*(1-B) + 0.0002*B )*r(206)
     &                +(0.0012*(1-B) + 0.0002*B )*r(207)
        Gain(kCAS2 )= +Gain(kCAS2 )+(0.0025*(1-B) + 0.0012*B )*r(204)
     &                +(0.0025*(1-B) + 0.0012*B )*r(205)
     &                +(0.0025*(1-B) + 0.0012*B )*r(206)
     &                +(0.0025*(1-B) + 0.0012*B )*r(207)
        Gain(kCAS3 )= +Gain(kCAS3 )+(0.0165*(1-B) + 0.0103*B )*r(204)
     &                +(0.0165*(1-B) + 0.0103*B )*r(205)
     &                +(0.0165*(1-B) + 0.0103*B )*r(206)
     &                +(0.0165*(1-B) + 0.0103*B )*r(207)
        Gain(kCAS4 )= +Gain(kCAS4 )+(0.0617*(1-B) + 0.0411*B )*r(204)
     &                +(0.0617*(1-B) + 0.0411*B )*r(205)
     &                +(0.0617*(1-B) + 0.0411*B )*r(206)
     &                +(0.0617*(1-B) + 0.0411*B )*r(207)
        Gain(kCAS1 )= +Gain(kCAS1 )+(0.0079*(1-B) + 0.0011*B )*r(208)
     &                +(0.0079*(1-B) + 0.0011*B )*r(209)
     &                +(0.0079*(1-B) + 0.0011*B )*r(210)
     &                +(0.0079*(1-B) + 0.0011*B )*r(211)
        Gain(kCAS2 )= +Gain(kCAS2 )+(0.0153*(1-B) + 0.0090*B )*r(208)
     &                +(0.0153*(1-B) + 0.0090*B )*r(209)
     &                +(0.0153*(1-B) + 0.0090*B )*r(210)
     &                +(0.0153*(1-B) + 0.0090*B )*r(211)
        Gain(kCAS3 )= +Gain(kCAS3 )+(0.0453*(1-B) + 0.0290*B )*r(208)
     &                +(0.0453*(1-B) + 0.0290*B )*r(209)
     &                +(0.0453*(1-B) + 0.0290*B )*r(210)
     &                +(0.0453*(1-B) + 0.0290*B )*r(211)
        Gain(kCAS4 )= +Gain(kCAS4 )+(0.1318*(1-B) + 0.0949*B )*r(208)
     &                +(0.1318*(1-B) + 0.0949*B )*r(209)
     &                +(0.1318*(1-B) + 0.0949*B )*r(210)
     &                +(0.1318*(1-B) + 0.0949*B )*r(211)
        Gain(kCBS1 )= +(0.0027*(1-B) + 0.0001*B )*r(189)
     &                +(0.0027*(1-B) + 0.0001*B )*r(190)
        Gain(kCBS2 )= +(0.0091*(1-B) + 0.0068*B )*r(189)
     &                +(0.0091*(1-B) + 0.0068*B )*r(190)
        Gain(kCBS3 )= +(0.0045*(1-B) + 0.0045*B )*r(189)
     &                +(0.0045*(1-B) + 0.0045*B )*r(190)
        Gain(kCBS4 )= +(0.0000 )*r(189)
     &                +(0.0000 )*r(190)
        Gain(kCBS1 )= +Gain(kCBS1 )+(0.0541*(1-B) + 0.0061*B )*r(193)
     &                +(0.0541*(1-B) + 0.0061*B )*r(194)
     &                +(0.0541*(1-B) + 0.0061*B )*r(195)
     &                +(0.0541*(1-B) + 0.0061*B )*r(196)
        Gain(kCBS2 )= +Gain(kCBS2 )+(0.0463*(1-B) + 0.0613*B )*r(193)
     &                +(0.0463*(1-B) + 0.0613*B )*r(194)
     &                +(0.0463*(1-B) + 0.0613*B )*r(195)
     &                +(0.0463*(1-B) + 0.0613*B )*r(196)
        Gain(kCBS3 )= +Gain(kCBS3 )+(0.1809*(1-B) + 0.1014*B )*r(193)
     &                +(0.1809*(1-B) + 0.1014*B )*r(194)
     &                +(0.1809*(1-B) + 0.1014*B )*r(195)
     &                +(0.1809*(1-B) + 0.1014*B )*r(196)
        Gain(kCBS4 )= +Gain(kCBS4 )+(0.3065*(1-B) + 0.2558*B )*r(193)
     &                +(0.3065*(1-B) + 0.2558*B )*r(194)
     &                +(0.3065*(1-B) + 0.2558*B )*r(195)
     &                +(0.3065*(1-B) + 0.2558*B )*r(196)
        Gain(kCBS1 )= +Gain(kCBS1 )+(0.0170 )*r(193)+(0.0170 )*r(194)
     &                +(0.0170 )*r(195)+(0.0170 )*r(196)
        Gain(kCBS2 )= +Gain(kCBS2 )+(0.0340 )*r(193)+(0.0340 )*r(194)
     &                +(0.0340 )*r(195)+(0.0340 )*r(196)
        Gain(kCBS3 )= +Gain(kCBS3 )+(0.1700 )*r(193)+(0.1700 )*r(194)
     &                +(0.1700 )*r(195)+(0.1700 )*r(196)
        Gain(kCBS4 )= +Gain(kCBS4 )+(0.2040 )*r(193)+(0.2040 )*r(194)
...
c
        ...
        Gain(kCBS1 )= +Gain(kCBS1 )+( 1.075)*r(231)+( 0.0  )*r(232)+( 0.0  )*r(233) !APT
